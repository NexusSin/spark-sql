...
data_path = "/home/users/fdollaku/Big_Data_Analytics/titanic.csv"
...
print(f"Part (b) - Passengers with age greater than median age (count: {result_count}):")
query_result.show(10)  # Show first 10 rows for brevity
